                ...
                <div className="flex w-full items-center gap-8 place-self-start sm:gap-10 lg:gap-12">
                  <div className="flex items-center">
                    <div className="!h-6 px-[16px] pb-[17px] pl-[10px]" style={{ padding: '0px', height: '100%', width: '100%' }}>
                      <button id="hamburgerIcon" data-testid="hamburgerIcon" className="!h-6 p-0" aria-label="Open Hamburger Menu" aria-expanded="false">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-black" style={{ color: 'white' }}>
                  ...
                  <div className="flex items-center gap-[6px]">
                    <button className="p-0">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-black" data-testid="search-icon" style={{ color: 'white' }}>
              ...
              <div className="sm:mt-0 sm:translate-y-1">
                <div className="flex w-full items-center justify-end place-self-end md:min-h-[26px]">
                  <div className="flex h-full w-full items-center justify-end gap-8 sm:gap-10 lg:gap-12">
                    <button className="inline-flex h-4 items-center justify-center gap-1 p-0 outline-none" type="button" id="radix-:r9:" aria-haspopup="menu" aria-expanded="false" data-state="closed" style={{ color: 'white' }}>
                      <p className="font-rhc font-thin h-[13px] whitespace-nowrap text-[13px] capitalize leading-[120%] tracking-[0.52px]">USA</p>
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none" className="text-black" style={{ color: 'white' }}>
                        <path d="M12.1699 6.75L8.16992 10.75L4.16992 6.75" stroke="currentColor" strokeWidth="0.75"></path>
                      </svg>
                    </button>
                    <div className="MuiGrid-root MuiGrid-item flex" style={{ color: 'white' }}>
                      <button className="p-0" style={{ color: 'white' }}>
            ...
            <ul className="flex flex-nowrap justify-between p-0 my-0" role="menubar" aria-label="Main">
              <div data-navigation-account-item-id="cat160024" className="mt-0 flex pt-0 no-underline underline-offset-[5px] hover:underline hover:text-white">
                <button type="button" aria-haspopup="dialog" aria-expanded="false" aria-controls="radix-:rt:" data-state="closed" className="p-0 text-black data-[state=open]:underline">
                  <span className="p-0 jss751 flex items-end" style={{ lineHeight: 'inherit' }}>
                    <span className="tailwind-typography-root uppercase h-[18px] font-rhc font-thin leading-normal tracking-wider md:text-[14px] lg:text-base tailwind-typography-caption" id="tailwind-rh-tailwind-typography" data-testid="rh-tailwind-typography" style={{ color: 'white', lineHeight: '1.75rem' }}>Living</span>
                  </span>
                </button>
              </div>
              <div data-navigation-account-item-id="cat1840042" className="mt-0 flex pt-0 no-underline underline-offset-[5px] hover:underline hover:text-white">
                <button type="button" aria-haspopup="dialog" aria-expanded="false" aria-controls="radix-:ru:" data-state="closed" className="p-0 text-black data-[state=open]:underline">
                  <span className="p-0 jss752 flex items-end" style={{ lineHeight: 'inherit' }}>
                    <span className="tailwind-typography-root uppercase h-[18px] font-rhc font-thin leading-normal tracking-wider md:text-[14px] lg:text-base tailwind-typography-caption" id="tailwind-rh-tailwind-typography" data-testid="rh-tailwind-typography" style={{ color: 'white', lineHeight: '1.75rem' }}>Dining</span>
                  </span>
                </button>
              </div>
              <div data-navigation-account-item-id="cat32450013" className="mt-0 flex pt-0 no-underline underline-offset-[5px] hover:underline hover:text-white">
                <button type="button" aria-haspopup="dialog" aria-expanded="false" aria-controls="radix-:rv:" data-state="closed" className="p-0 text-black data-[state=open]:underline">
                  <span className="p-0 jss753 flex items-end" style={{ lineHeight: 'inherit' }}>
                    <span className="tailwind-typography-root uppercase h-[18px] font-rhc font-thin leading-normal tracking-wider md:text-[14px] lg:text-base tailwind-typography-caption" id="tailwind-rh-tailwind-typography" data-testid="rh-tailwind-typography" style={{ color: 'white', lineHeight: '1.75rem' }}>Bed</span>
                  </span>
                </button>
              </div>
              <div data-navigation-account-item-id="cat160092" className="mt-0 flex pt-0 no-underline underline-offset-[5px] hover:underline hover:text-white">
                <button type="button" aria-haspopup="dialog" aria-expanded="false" aria-controls="radix-:r10:" data-state="closed" className="p-0 text-black data-[state=open]:underline">
                  <span className="p-0 jss754 flex items-end" style={{ lineHeight: 'inherit' }}>
                    <span className="tailwind-typography-root uppercase h-[18px] font-rhc font-thin leading-normal tracking-wider md:text-[14px] lg:text-base tailwind-typography-caption" id="tailwind-rh-tailwind-typography" data-testid="rh-tailwind-typography" style={{ color: 'white', lineHeight: '1.75rem' }}>Bath</span>
                  </span>
                </button>
              </div>
              <div data-navigation-account-item-id="cat180003" className="mt-0 flex pt-0 no-underline underline-offset-[5px] hover:underline hover:text-white">
                <button type="button" aria-haspopup="dialog" aria-expanded="false" aria-controls="radix-:r11:" data-state="closed" className="p-0 text-black data-[state=open]:underline">
                  <span className="p-0 jss755 flex items-end" style={{ lineHeight: 'inherit' }}>
                    <span className="tailwind-typography-root uppercase h-[18px] font-rhc font-thin leading-normal tracking-wider md:text-[14px] lg:text-base tailwind-typography-caption" id="tailwind-rh-tailwind-typography" data-testid="rh-tailwind-typography" style={{ color: 'white', lineHeight: '1.75rem' }}>Outdoor</span>
                  </span>
                </button>
              </div>
              <div data-navigation-account-item-id="cat160075" className="mt-0 flex pt-0 no-underline underline-offset-[5px] hover:underline hover:text-white">
                <button type="button" aria-haspopup="dialog" aria-expanded="false" aria-controls="radix-:r12:" data-state="closed" className="p-0 text-black data-[state=open]:underline">
                  <span className="p-0 jss756 flex items-end" style={{ lineHeight: 'inherit' }}>
                    <span className="tailwind-typography-root uppercase h-[18px] font-rhc font-thin leading-normal tracking-wider md:text-[14px] lg:text-base tailwind-typography-caption" id="tailwind-rh-tailwind-typography" data-testid="rh-tailwind-typography" style={{ color: 'white', lineHeight: '1.75rem' }}>Lighting</span>
                  </span>
                </button>
              </div>
              <div data-navigation-account-item-id="cat9750013" className="mt-0 flex pt-0 no-underline underline-offset-[5px] hover:underline hover:text-white">
                <button type="button" aria-haspopup="dialog" aria-expanded="false" aria-controls="radix-:r13:" data-state="closed" className="p-0 text-black data-[state=open]:underline">
                  <span className="p-0 jss757 flex items-end" style={{ lineHeight: 'inherit' }}>
                    <span className="tailwind-typography-root uppercase h-[18px] font-rhc font-thin leading-normal tracking-wider md:text-[14px] lg:text-base tailwind-typography-caption" id="tailwind-rh-tailwind-typography" data-testid="rh-tailwind-typography" style={{ color: 'white', lineHeight: '1.75rem' }}>Textiles</span>
                  </span>
                </button>
              </div>
              <div data-navigation-account-item-id="cat1535014" className="mt-0 flex pt-0 no-underline underline-offset-[5px] hover:underline hover:text-white">
                <button type="button" aria-haspopup="dialog" aria-expanded="false" aria-controls="radix-:r14:" data-state="closed" className="p-0 text-black data-[state=open]:underline">
                  <span className="p-0 jss758 flex items-end" style={{ lineHeight: 'inherit' }}>
                    <span className="tailwind-typography-root uppercase h-[18px] font-rhc font-thin leading-normal tracking-wider md:text-[14px] lg:text-base tailwind-typography-caption" id="tailwind-rh-tailwind-typography" data-testid="rh-tailwind-typography" style={{ color: 'white', lineHeight: '1.75rem' }}>Rugs</span>
                  </span>
                </button>
              </div>
              <div data-navigation-account-item-id="cat1630014" className="mt-0 flex pt-0 no-underline underline-offset-[5px] hover:underline hover:text-white">
                <button type="button" aria-haspopup="dialog" aria-expanded="false" aria-controls="radix-:r15:" data-state="closed" className="p-0 text-black data-[state=open]:underline">
                  <span className="p-0 jss759 flex items-end" style={{ lineHeight: 'inherit' }}>
                    <span className="tailwind-typography-root uppercase h-[18px] font-rhc font-thin leading-normal tracking-wider md:text-[14px] lg:text-base tailwind-typography-caption" id="tailwind-rh-tailwind-typography" data-testid="rh-tailwind-typography" style={{ color: 'white', lineHeight: '1.75rem' }}>Décor</span>
                  </span>
                </button>
              </div>
              <div data-navigation-account-item-id="cat26600024" className="mt-0 flex pt-0 no-underline underline-offset-[5px] hover:underline hover:text-white">
                <a href="https://rhbabyandchild.rh.com/us/en/" target="_blank" className="jss760 flex items-end">
                  <span className="tailwind-typography-root uppercase h-[18px] font-rhc font-thin leading-normal tracking-wider md:text-[14px] lg:text-base tailwind-typography-caption" id="tailwind-rh-tailwind-typography" data-testid="rh-tailwind-typography" style={{ color: 'white', lineHeight: '1.75rem' }}>BABY &amp; CHILD</span>
                </a>
              </div>
              <div data-navigation-account-item-id="cat26600023" className="mt-0 flex pt-0 no-underline underline-offset-[5px] hover:underline hover:text-white">
                <a href="https://rhteen.rh.com/us/en/" target="_blank" className="jss761 flex items-end">
                  <span className="tailwind-typography-root uppercase h-[18px] font-rhc font-thin leading-normal tracking-wider md:text-[14px] lg:text-base tailwind-typography-caption" id="tailwind-rh-tailwind-typography" data-testid="rh-tailwind-typography" style={{ color: 'white', lineHeight: '1.75rem' }}>TEEN</span>
                </a>
              </div>
              ...
              <div data-navigation-account-item-id="cat28610168" className="mt-0 flex pt-0 no-underline underline-offset-[5px] hover:underline hover:text-white">
                <button type="button" aria-haspopup="dialog" aria-expanded="false" aria-controls="radix-:r17:" data-state="closed" className="p-0 text-black data-[state=open]:underline">
                  <span className="p-0 jss762 flex items-end" style={{ lineHeight: 'inherit' }}>
                    <span className="tailwind-typography-root uppercase h-[18px] font-rhc font-thin leading-normal tracking-wider md:text-[14px] lg:text-base tailwind-typography-caption" id="tailwind-rh-tailwind-typography" data-testid="rh-tailwind-typography" style={{ color: 'white', lineHeight: '1.75rem' }}>Interior Design</span>
                  </span>
                </button>
              </div>
            </ul>
